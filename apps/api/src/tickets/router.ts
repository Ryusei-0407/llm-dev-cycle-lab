...
// Per-request context injected at the /api/rpc mount (app.ts): the resolved
// session user, or null when the request carries no valid session. reply reads
// it to author the message; the read procedures ignore it.
